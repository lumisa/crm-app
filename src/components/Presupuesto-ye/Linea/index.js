...
const Linea = () => {
    ...
    const [products, setProducts] = useState([
        {concepto: "Trina Solar", precio: 150, ud: 1, total: 150},
        {concepto: "Inversor", precio: 200, ud: 1, total: 200},

    ])


    const onChangeUd = (event) => {
        ...
        {products.map( (value, i) => (
            ...
            <div class="row form-group">
                <div class="col-6"><span id="concepto-${key}">${value.concepto} </span></div>
                    <div class="col-1">
                        <input type="number" onChange={onChangeUd(event)} step="1" class="form-control" value="${presupuestoUd[modalidad][key].ud}" id="ud-${key}" name="ud-${key}" title="Completar" placeholder="" style="width:100%;"/>
                    </div>
                    <div class="col-3">
